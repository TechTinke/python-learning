...
# and the other fields have already been populated like for example in this case owner
# was created after title and descripiton were already defined,
#  an error is thrown and you
...
class Post(models.Model):
    ...
    title = models.CharField(max_length=100) #CharField is for characters
